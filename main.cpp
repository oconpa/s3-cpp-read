...
bool Check_ext(Aws::String const& filename);
...
static invocation_response my_handler(invocation_request const& req, Aws::S3::S3Client const& client)
{
    ...
    return invocation_response::success("success" + base64_encoded_file, "application/json");
}
...
bool Check_ext(Aws::String const& filename)
{
    ...
    Aws::String ext = filename.substr(pos+1);
